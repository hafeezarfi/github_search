  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return _SearchResultItems(item: items[index]);
      },
    );
  }
}

class _SearchResultItems extends StatelessWidget {
  const _SearchResultItems({Key? key, required this.item}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: CircleAvatar(
        child: Image.network(item.owner.avaratUrl),
      ),
